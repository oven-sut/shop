  ...
  return (
    <div className="space-y-6 text-sm leading-relaxed text-slate-700">
      <header className="space-y-1 pb-4 border-b border-slate-100">
        <h1 className="text-2xl font-extrabold text-slate-900">ข้อกำหนดการใช้งาน</h1>
        <p className="text-xs text-slate-400">ปรับปรุงล่าสุด {UPDATED}</p>
      </header>

      <section className="space-y-2">
        <h2 className="text-base font-bold text-slate-900">1. การยอมรับข้อกำหนด</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-base font-bold text-slate-900">2. บัญชีผู้ใช้</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-base font-bold text-slate-900">3. การเติมเงินเข้ากระเป๋า</h2>
        <ul className="list-disc pl-5 space-y-1">
          <li>
      ...
      <section className="space-y-2">
        <h2 className="text-base font-bold text-slate-900">4. การสั่งซื้อและราคา</h2>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section className="space-y-2">
        <h2 className="text-base font-bold text-slate-900">5. สินค้าดิจิทัลและการคืนเงิน</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-base font-bold text-slate-900">6. ข้อห้าม</h2>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section className="space-y-2">
        <h2 className="text-base font-bold text-slate-900">7. การจำกัดความรับผิด</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-base font-bold text-slate-900">8. การแก้ไขข้อกำหนด</h2>
        <p>
      ...
      <section className="space-y-2 pt-4 border-t border-slate-100">
        <h2 className="text-base font-bold text-slate-900">9. ติดต่อ</h2>
        <p className="text-slate-500">
          ผู้ให้บริการ: <span className="font-semibold text-slate-700">[ระบุชื่อผู้ประกอบการ]</span>
